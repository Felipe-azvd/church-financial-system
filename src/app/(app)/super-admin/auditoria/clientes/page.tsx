              ...
              {logs.length === 0 ? (
                ...
                logs.map((log) => (
                  <tr key={log.id} className="flex flex-col bg-transparent py-4 border-b border-white/5 last:border-b-0 md:table-row md:py-0 md:border-white/5 md:hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="flex justify-between items-center py-2 border-b border-white/5 last:border-b-0 md:table-cell md:border-none md:p-4 text-sm font-semibold text-white">
                    ...
                    <td className="flex justify-between items-center py-2 border-b border-white/5 last:border-b-0 md:table-cell md:border-none md:p-4 text-sm text-white/80">
                    ...
                    <td className="flex justify-between items-center py-2 border-b border-white/5 last:border-b-0 md:table-cell md:border-none md:p-4 text-sm text-[var(--text-muted)] md:max-w-[250px] md:truncate text-right md:text-left">
